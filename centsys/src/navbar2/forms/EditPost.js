...
const Add = () => {
    ...
    console.log("titl", payload.title)
    ...
    const handleSubmit = (e) => {
        ...
        axiosClient.post('edit/articles/', formData)
            .then((response) => {
    ...
    return (
        <div className='flex gap-7  bg-slate-300'>
            ...
            <div className='w-full h-scre bg-slate-400 p-3'>
                <p className='text-center md:text-2xl font-extrabold text-neutral-600'>Edit This Article</p>
                <form className='  place-items-center relativ md:p-4' onSubmit={handleSubmit} encType='multipart/form-data'>
                    ...
                    <div className='md:w-full bg-green-00'>
                        ...
                        <div className=' flex'>
                            <label htmlFor='image' className='ml-2 text-4x cursor-pointer text-blue-800' title='Edit FrontLine Image'>
                                <div>
                        ...
                        <div className='flex justify-center w-full'>
                            <button className='w-6/12 p-1 h-10 font-bold text-neutral-300 bg-green-400 hover:bg-green-500 rounded'>Update Post</button>
                        </div>
                    </div>
                </form>
            </div>
